export class RestClient {
    ...
    public post<TResponse>(path: string, body: BodyInit, headers: HeadersInit = {}): Promise<TResponse> {
      return this.request<TResponse>(path, {
        method: "POST",
        credentials: "include",
        headers: {
    ...
    public put<TRequest, TResponse>(path: string, body: TRequest, headers: HeadersInit = {}): Promise<TResponse> {
      return this.request<TResponse>(path, {
        method: "PUT",
        credentials: "include",
        headers: {
