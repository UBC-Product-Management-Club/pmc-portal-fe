...
describe('PaymentService', () => {
  ...
  describe("fetches element options for", () => {
    ...
    it("membership fee for ubc student", async () => {
        ...
        const result = await service.getElementsOptions({type: PaymentType.MEMBERSHIP, university: Universities[0]})
    ...
    it("membership fee for non-ubc student", async () => {
        ...
        const result = await service.getElementsOptions({type: PaymentType.MEMBERSHIP, university: Universities[1]})
    ...
    it("event fee", async () => {
        ...
        const result = await service.getElementsOptions({type: PaymentType.EVENT, eventId: "eventId"})
