...
const Event: React.FC = () => {
    ...
    // const isEventFull = event?.maxAttendee !== null && event.attendee_Ids?.length >= event.maxAttendee;
    ...
    return (
        <div className="background-event">
            ...
            <button className={`signup-button ${event.maxAttendee !== null &&
                event.attendee_Ids?.length >= event.maxAttendee
                ? "disabled-button"
                : ""
                }`} onClick={() => setIsSignUpFormOpen(true)}
                disabled={
                    event.maxAttendee !== null &&
                    event.attendee_Ids?.length >= event.maxAttendee
                }
            >Sign up</button>
            ...
            {event.maxAttendee !== null && event.attendee_Ids?.length >= event.maxAttendee && (
