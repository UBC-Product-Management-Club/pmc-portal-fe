    ...
    return (
        <div className="event-registration-form">
            ...
            <div className="event-registration-form-buttons">
                <button className="pmc-button pmc-button-white" onClick={onSignInOrCreateAccount}>
                    Sign in / Create an account
                </button>
                <button className="pmc-button pmc-button-transparent" onClick={onContinueAsGuest}>
