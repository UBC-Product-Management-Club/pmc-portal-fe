...
enum Pages {
    USER_INFO, MEMBERSHIP, PAYMENT, PAYMENT_SUCCESS
}
            ...
            <Container data-testid="onboarding">
                <Content>
                    ...
                    {currPage === Pages.MEMBERSHIP && fee && user && (
                        <>
                        <PaymentHeader>To become a PMC member for the 2025/2026 academic year, a {charge} membership fee is required. Would you like to become a member?</PaymentHeader>
                        <ButtonRow>
                            <StyledButton
                            onClick={() => {
                            ...
                            <Payment
                              ...
                              onPayment={(payment: PaymentIntent) => {
                                ...
                                try {
                                    ...
                                    try {
                                        userService.create(user as UserDataFromUser);
                                        setCurrPage(Pages.PAYMENT_SUCCESS);
                                    } catch (error: unknown) {
                                        // we're fucked. maybe this can notify us or something
                                        if (error instanceof ZodError) {
