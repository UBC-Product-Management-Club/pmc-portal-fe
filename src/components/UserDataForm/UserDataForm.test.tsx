...
describe('UserDataForm', () => {
    ...
    describe('conditionally renders', () => {
        ...
        it('renders correct fields for ubc student', async () => {
            ...
            fireEvent.change(screen.getByTestId("university-dropdown"), { target: { value: "University of British Columbia"}})
        ...
        it('major/faculty/year input if uni student', async () => {
            ...
            fireEvent.change(screen.getByTestId("university-dropdown"), { target: { value: "Other"}})
        ...
        it('neither if not uni student', async () => {
            ...
            fireEvent.change(screen.getByTestId("university-dropdown"), { target: { value: "I'm not a university student"}})
    ...
    describe('waiver', () => {
        ...
        it('doesnt render for non-ubc', async () => {
            ...
            fireEvent.change(screen.getByTestId("university-dropdown"), { target: { value: "Simon Fraser University" }})
    ...
    it('renders with previous responses', async () => {
        ...
        Object.values(user).forEach((value) => expect(screen.getByDisplayValue(value)).toBeInTheDocument())
    })
})